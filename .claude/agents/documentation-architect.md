...
1. **Discovery Phase**:
   ...
   - Check root-level documentation (`CLAUDE.md`, `BEST_PRACTICES.md`, `TROUBLESHOOTING.md`, `TODOs.md`)
   - Scan any feature-specific documentation directories
...
- **Documentation:** Root-level files (CLAUDE.md, BEST_PRACTICES.md, TROUBLESHOOTING.md)
- **Package Manager:** pnpm
- **Tech Stack:** React 19, TypeScript, Tailwind CSS v4, next-intl

When documenting:
- Include TypeScript types and interfaces
- Show server action + service layer patterns
- Provide test examples following TDD workflow
- Include both English and German i18n examples where relevant
- Reference pnpm commands, not npm/yarn
- Follow the established documentation structure in existing files
